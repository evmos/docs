...
:::note
If you are planning on developing on Evmos locally and you haven’t already set up your own local node, refer to [the quickstart tutorial](../../develop/build-a-dApp/run-a-node), or follow the instructions in the [GitHub repository](https://github.com/evmos/evmos/).
:::
...
- Testnet
    ...
    - **Chain ID:** <Highlighter keyword="testnet_ticker" />
