...
| `https://evmos.drpc.org`                      | Èthereum` `JSON-RPC`   | [dRPC](https://drpc.org/)  | Pruned |
...
| `https://drpc.org/chainlist/evmos#evmos-testnet`             | `Ethereum` `JSON-RPC`  | [dRPC](https://drpc.org/)               | Pruned  |
