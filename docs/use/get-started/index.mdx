...
Evmos is a flagship implementation that provides a scalable, high-throughput Proof-of-Stake (PoS) blockchain and is fully compatible and
...
* Exposing a fully compatible Web3 [JSON-RPC](./../../develop/build-a-dApp/clients/ethereum-JSON-RPC/JSON-RPC) layer for interacting with existing Ethereum clients and tooling ([Metamask](./../wallet/metamask), [Remix](https://academy.evmos.org), [Truffle](https://academy.evmos.org), etc).
