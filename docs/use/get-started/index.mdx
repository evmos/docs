...
Evmos is the blockchain network, that lets you use a new generation of applications, built by developers permissionless across the world.

We believe that you shouldn't be constrained to interacting only with applications on one blockchain. This creates a bad user experience forcing you to reconnect to new networks and transfer currencies between different blockchains. Instead, you should be able to seamlessly use applications, regardless of where they are built.
